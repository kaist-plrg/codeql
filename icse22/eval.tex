...
\inred{Figure~\ref{fig:graph} shows the analysis time of \ours compared to
...
\inred{Note that 12 out of 33 bugs \ours found JN-Sum was not able to find
because of the memory or scalability issues.}
