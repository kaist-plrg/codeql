...
\begin{figure}[t]
  ...
  \vspace*{-1.5em}
  \caption{Analysis time comparison between ours and ASE'20}
  \label{fig:graph}
\vspace*{-.5em}
\end{figure}
...
ObscuraCam. As described in \inred{Section~\ref{}}, JNI has a C function naming
convention for JVMs to link Java native methods to the corresponding C
functions~\cite{jninaming}. While a Java class {\tt JpegRedaction} declaring a
