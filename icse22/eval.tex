...
C-to-Java field accesses. In addition, 1,008 (86\%) resolved JNI uses are precise.
\inred{The results show that \ours resolves more JNI uses even precisely than JN-Sum
