...
the integrated programs.  Since the extension of JVML cannot
...
calls from binaries, used in further declarative-style Java
...
\subsection{Static Analysis for Other FFIs}
...
Declarative analysis alleviates the challenges in crafting a static
