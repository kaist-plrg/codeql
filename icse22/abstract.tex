...
they often \inred{fail to analyze within a limited time budget}.
...
Our evaluation shows that the analyzer is {\it precise} in that it analyzes
dataflows with higher precision and is {\it scalable} in that it \inred{succeeds
to analyze apps that the state-of-the-art analyzers fail and detects same types
