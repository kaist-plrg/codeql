...
related to specific properties via query systems.
Declarative static analyzers can easily target diverse programming languages
by modifying only databases and rules
for new languages. Because query systems are independent of
programming languages, they are reusable for new languages.
However, they only support monolingual programs written in each language,
but not multilingual programs written in two or more programming languages.
With the growing prevalence of multilingual programs in diverse areas,
supporting multilingual program analysis is becoming increasingly important.
