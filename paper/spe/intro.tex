...
Java-C and Python-C language boundaries. \inred{ The evaluation shows that
\ours is scalabale enough to fully analyze three million lines of codes in 12 minutes,
in contrast to the previous state-of-the-art analyzer fialed to analyze.
Also, it detects 33 genuine interoperation
bugs in real-world Java-C programs, including 12 brand-new bugs that were
not detected by the previous analyzer.}
...
\item We show that \inred{\ours can sucessfully detect}
dataflow-related bugs at language boundaries of real-world multilingual
programs, \inred{including new bugs that the state-of-the-art analyzers could not find.}
