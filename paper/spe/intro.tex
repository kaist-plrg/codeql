...
\inblue{Declarative static analysis is a paradigm of static analysis for detecting bugs
...
directly support the analysis of \inblue{\textit{multilingual programs}} written in two
...
declarative static analyzer, \inblue{called \ours}, for multilingual programs by
...
\inblue{The evaluation shows that \ours is scalable enough in the sense that it takes
...
\inblue{called \ours}, for two types of multilingual programs, Java-C and Python-C, by
extending CodeQL.

\item \inblue{We show that \ours can sucessfully detect dataflow-related bugs at
