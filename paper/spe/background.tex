...
assignments that make every substituted fact is included in the set of all derived factcs. This step corresponds
...
the query result, which is the set of all possible value that the variable \rcode{ X}
can be substitued with, as the output of the query.
