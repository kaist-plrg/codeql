...
of a set of facts containing variables, and the query system finds all variable
assignments that make every fact in that set can be derived from the rules and
...
\noindent
that queries all nodes into which the integer literal {\tt 42} flow.  
