...
monolingual programs, the query system now produces \rcode{ (X, Y) $\in$ \{(6,
2), (3, 7), } \rcode{(8, 4)\}} as function call relation results, which include
not only intraoperation call relations but also interoperation call relations. 
