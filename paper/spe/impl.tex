...
Answering these questions soundly requires inter-language dataflow analysis,
because the string or method ID values may be passed across language boundary.
However, we observed that such pattern rarely happens in practice,
...
as a trade-off for more lightweight and simpler implementation.
