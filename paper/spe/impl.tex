...
\end{lstlisting}
    \vspace*{-.5em}
    \caption{jni/dataflow/internal/DataFlowUtil.qll}
    \label{fig:qll3}
  \end{subfigure}
  \vspace*{-.5em}
...
First, as in lines 1 and 2 of Figure~\ref{fig:qll3}, we encapsulate each of the original dataflow libraries with a CodeQL
...
The following shows the \codeql{viableCallable} predicate we extended for the
