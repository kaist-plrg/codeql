...
\inblue{Polycruise~\cite{polycruise} is a Python-C analyzer that enables an efficeint
dynamic information flow analysis(DIFA).
The analysis is performed in two phases. The main idea is to compute the
symbolic dependencies regarding dataflow sources and sinks, and use that
information to make more efficeint instrumentations and peform dynamic analysis online.
