...
%
\inred{The results show that \ours can successfully analyze JNI programs that
...
\inred{For this real-world benchmark, we compare the analysis results of
...
\inred{The first column shows app names with their indices, the second shows the lines of code,}
...
three million lines of code in about \inred{12} minutes.

\inred{In summary, the evaluation with the second benchmark suite shows that
...
\inred{In the failed benchmarks, the C code changes the values of the fields in Python objects that are passed
...
The first column shows repository names, \inred{the second shows the lines of code,
...
\inred{The evaluation shows that \ours can detect various JNI interoperation bugs in
