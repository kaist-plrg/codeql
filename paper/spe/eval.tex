...
Li et al.~\cite{vulnerable-multi} explain, \inblue{there are various interoperation mechanisms
beyond explicit FFIs, such as implicit interaction between languages using interprocess communication
(e.g., socket-based message passing) or a language totally emobodying another langauge
