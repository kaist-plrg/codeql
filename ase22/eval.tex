...
For \req{2}, we specifically detect JNI interoperation bugs in the 42 real-world Android
...
selected by finding function calls with prefix \ccode{PyObject\_},
\ccode{PyList\_}, \ccode{PyTuple\_}, \ccode{PyDict\_}, and \ccode{PyArg\_}.
