...
/** A file or folder. */
class Container extends @java_container, Top {
  /**
  ...
  Container getParentContainer() { java_containerparent(result, this) }
...
/** A folder. */
class Folder extends Container, @java_folder {
  override string getAbsolutePath() { java_folders(this, result, _) }
 ...
 */
class File extends Container, @java_file {
  override string getAbsolutePath() { java_files(this, result, _, _, _) }
...
class JarFile extends File {
   ...
   */
  string getManifestMainAttribute(string key) { java_jarManifestMain(this, key, result) }
  ...
  string getManifestEntryAttribute(string entry, string key) {
    java_jarManifestEntries(this, entry, key, result)
  }
}
