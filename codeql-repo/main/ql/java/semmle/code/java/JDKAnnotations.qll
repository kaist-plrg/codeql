...
class TargetAnnotation extends Annotation {
   ...
   * `@java_Target({ElementType.FIELD, ElementType.METHOD})`.
   */
...
class RetentionAnnotation extends Annotation {
   ...
   * retention policy expression in `@java_Retention(RetentionPolicy.RUNTIME)`.
   */
   ...
   * in `@java_Retention(RetentionPolicy.RUNTIME)`.
   */
