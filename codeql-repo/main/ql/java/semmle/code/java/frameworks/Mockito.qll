...
class MockitoInitedTest extends Class {
  MockitoInitedTest() {
    ...
    or
    // Call to `MockitoAnnotations.initMocks()`, either by the constructor or by a `@java_Before` method.
...
/**
 * A field annotated with the Mockito `@java_Mock` annotation, indicating the field will be mocked.
 */
class MockitoMockedField extends MockitoAnnotatedField {
  ...
  /**
   * Holds if this mock may be referenced by an `@java_InjectMocks` annotated field.
   */
  predicate isReferencedByInjection() {
    ...
    |
      // A `@java_Mock` is injected if it is used in one of the invoked callables (constructor or
...
/**
 * A field annotated with `@java_InjectMocks`.
 */
...
/**
 * A field annotated with the Mockito `@java_Spy` annotation.
 */
...
/**
 * A class which is referenced by an `@java_InjectMocks` field.
 */
library class MockitoMockInjectedClass extends Class {
  MockitoMockInjectedClass() {
    // There must be an `@java_InjectMock` field that has `this` as the type.
