...
class SessionEJB extends EJB {
  ...
  /** Any `@java_Init` methods required for `@java_RemoteHome` or `@java_LocalHome` legacy interfaces. */
...
abstract class EjbInterfaceAnnotation extends Annotation {
   ...
   *
   * For example, types `Foo` and `Bar` are named within `@java_Remote({Foo.class, Bar.class})`.
   */
...
/**
 * Common superclass representing a `@java_Remote` or `@java_Local` annotation
...
/**
 * An instance of a `@java_Remote` annotation.
 */
...
/**
 * An instance of a `@java_Local` annotation.
 */
...
/**
 * A business interface annotated with `@java_Local` or `@java_Remote` or
 * named within a `@java_Local` or `@java_Remote` annotation of another type.
 */
class AnnotatedBusinessInterface extends BusinessInterface {
  AnnotatedBusinessInterface() {
    // An interface annotated as `@java_Remote` or `@java_Local`.
    this.getAnAnnotation() instanceof BusinessInterfaceAnnotation
    or
    // An interface named within a `@java_Local` or `@java_Remote` annotation of another type.
    exists(BusinessInterfaceAnnotation a | a.getANamedType() = this)
  }

  /**
   * Any class that has a `@java_Local` or `@java_Remote` annotation that names this interface
...
/**
 * A remote business interface declared using the `@java_Remote` annotation.
 */
...
/**
 * A local business interface declared using the `@java_Local` annotation.
 */
...
/**
 * A `@java_javax.ejb.Init` annotation.
 */
...
/**
 * A method annotated with a `@java_javax.ejb.Init` annotation
...
/** Common superclass for `@java_RemoteHome` and `@java_LocalHome` annotations. */
abstract class HomeAnnotation extends EjbInterfaceAnnotation { }

/**
 * An instance of a `@java_RemoteHome` annotation.
 */
...
/**
 * An instance of a `@java_LocalHome` annotation.
 */
...
/** A legacy remote home interface specified by means of a `@java_RemoteHome` annotation. */
class AnnotatedRemoteHomeInterface extends LegacyEjbRemoteHomeInterface {
  AnnotatedRemoteHomeInterface() {
    // An interface named within a `@java_RemoteHome` annotation of another type.
...
/** A legacy local home interface specified by means of a `@java_LocalHome` annotation. */
class AnnotatedLocalHomeInterface extends LegacyEjbLocalHomeInterface {
  AnnotatedLocalHomeInterface() {
    // An interface named within a `@java_LocalHome` annotation of another type.
...
/**
 * Holds if `ejb` inherits an `ejbCreate` or `@java_Init` method matching `create` method `m`.
...
/**
 * If `ejb` inherits an `ejbCreate` or `@java_Init` method matching `create` method `m` except for the `throws` clause,
 * then return any type in the `throws` clause that does not match.
 */
...
/**
 * A `@java_javax.ejb.AccessTimeout` annotation.
 */
...
/**
 * A `@java_javax.ejb.ActivationConfigProperty` annotation.
 */
...
/**
 * A `@java_javax.ejb.AfterBegin` annotation.
 */
...
/**
 * A `@java_javax.ejb.AfterCompletion` annotation.
 */
...
/**
 * A `@java_javax.ejb.ApplicationException` annotation.
 */
...
/**
 * A `@java_javax.ejb.Asynchronous` annotation.
 */
...
/**
 * A `@java_javax.ejb.BeforeCompletion` annotation.
 */
...
/**
 * A `@java_javax.ejb.ConcurrencyManagement` annotation.
 */
...
/**
 * A `@java_javax.ejb.DependsOn` annotation.
 */
...
/**
 * A `@java_javax.ejb.EJB` annotation.
 */
...
/**
 * A `@java_javax.ejb.EJBs` annotation.
 */
...
/**
 * A `@java_javax.ejb.LocalBean` annotation.
 */
...
/**
 * A `@java_javax.ejb.Lock` annotation.
 */
...
/**
 * A `@java_javax.ejb.MessageDriven` annotation.
 */
...
/**
 * A `@java_javax.ejb.PostActivate` annotation.
 */
...
/**
 * A `@java_javax.ejb.PrePassivate` annotation.
 */
...
/**
 * A `@java_javax.ejb.Remove` annotation.
 */
...
/**
 * A `@java_javax.ejb.Schedule` annotation.
 */
...
/**
 * A `@java_javax.ejb.Schedules` annotation.
 */
...
/**
 * A `@java_javax.ejb.Singleton` annotation.
 */
...
/**
 * A `@java_javax.ejb.Startup` annotation.
 */
...
/**
 * A `@java_javax.ejb.Stateful` annotation.
 */
...
/**
 * A `@java_javax.ejb.StatefulTimeout` annotation.
 */
...
/**
 * A `@java_javax.ejb.Stateless` annotation.
 */
...
/**
 * A `@java_javax.ejb.Timeout` annotation.
 */
...
/**
 * A `@java_javax.ejb.TransactionAttribute` annotation.
 */
...
/**
 * A `@java_javax.ejb.TransactionManagement` annotation.
 */
...
/**
 * A `@java_javax.ejb.TransactionAttribute` annotation with the
...
/**
 * Gets the innermost `@java_javax.ejb.TransactionAttribute` annotation for method `m`.
 */
