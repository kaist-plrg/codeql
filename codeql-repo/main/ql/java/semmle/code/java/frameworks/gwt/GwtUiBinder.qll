...
/**
 * A `@java_com.google.gwt.uibinder.client.UiHandler` annotation.
 */
...
/**
 * A `@java_com.google.gwt.uibinder.client.UiField` annotation.
 */
...
/**
 * A `@java_com.google.gwt.uibinder.client.UiTemplate` annotation.
 */
...
/**
 * A `@java_com.google.gwt.uibinder.client.UiFactory` annotation.
 */
...
/**
 * A `@java_com.google.gwt.uibinder.client.UiConstructor` annotation.
 */
