...
class Variable extends @java_variable, Annotatable, Element, Modifiable {
  /** Gets the type of this variable. */
  /*abstract*/ Type getType() { none() }

  /** Gets an access to this variable. */
  VarAccess getAnAccess() { java_variableBinding(result, this) }
...
class LocalScopeVariable extends Variable, @java_localscopevariable {
  /** Gets the callable in which this variable is declared. */
  abstract Callable getCallable();
}

/** A local variable declaration */
class LocalVariableDecl extends @java_localvar, LocalScopeVariable {
  /** Gets the type of this local variable. */
  override Type getType() { java_localvars(this, _, result, _) }

  /** Gets the expression declaring this variable. */
  LocalVariableDeclExpr getDeclExpr() { java_localvars(this, _, _, result) }

  /** Gets the parent of this declaration. */
  Expr getParent() { java_localvars(this, _, _, result) }
...
class Parameter extends Element, @java_param, LocalScopeVariable {
  /** Gets the type of this formal parameter. */
  override Type getType() { java_params(this, result, _, _, _) }
  ...
  int getPosition() { java_params(this, _, result, _, _) }

  /** Gets the callable that declares this formal parameter. */
  override Callable getCallable() { java_params(this, _, _, result, _) }

  /** Gets the source declaration of this formal parameter. */
  Parameter getSourceDeclaration() { java_params(this, _, _, _, result) }
  ...
  predicate isVarargs() { java_isVarargsParam(this) }
