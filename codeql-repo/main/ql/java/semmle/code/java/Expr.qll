...
class Expr extends ExprParent, @java_expr {
  /*abstract*/ override string toString() { result = "expr" }

  /**
   * Gets the callable in which this expression occurs, if any.
   */
  Callable getEnclosingCallable() { java_callableEnclosingExpr(this, result) }

  /** Gets the index of this expression as a child of its parent. */
  int getIndex() { java_exprs(this, _, _, _, result) }

  /** Gets the parent of this expression. */
  ExprParent getParent() { java_exprs(this, _, _, result, _) }

  /** Holds if this expression is the child of the specified parent at the specified (zero-based) position. */
  predicate isNthChildOf(ExprParent parent, int index) { java_exprs(this, _, _, parent, index) }

  /** Gets the type of this expression. */
  Type getType() { java_exprs(this, _, result, _, _) }
   ...
   */
  int getKind() { java_exprs(this, result, _, _, _) }
  ...
  Stmt getEnclosingStmt() { java_statementEnclosingExpr(this, result) }
  ...
  Expr getAChildExpr() { java_exprs(result, _, _, this, _) }
  ...
  predicate isParenthesized() { java_isParenthesized(this, _) }
}
...
class ExprParent extends @java_exprparent, Top { }
 ...
 */
class ArrayAccess extends Expr, @java_arrayaccess {
 ...
 */
class ArrayCreationExpr extends Expr, @java_arraycreationexpr {
 ...
 */
class ArrayInit extends Expr, @java_arrayinit {
  /**
...
class Assignment extends Expr, @java_assignment {
 ...
 * For example, `x = 23`.
 */
class AssignExpr extends Assignment, @java_assignexpr {
 ...
 */
class AssignOp extends Assignment, @java_assignop {
  /**
...
class AssignAddExpr extends AssignOp, @java_assignaddexpr {
...
/** A compound assignment expression using the `-=` operator. */
class AssignSubExpr extends AssignOp, @java_assignsubexpr {
  override string getOp() { result = "-=" }
...
/** A compound assignment expression using the `*=` operator. */
class AssignMulExpr extends AssignOp, @java_assignmulexpr {
  override string getOp() { result = "*=" }
...
/** A compound assignment expression using the `/=` operator. */
class AssignDivExpr extends AssignOp, @java_assigndivexpr {
  override string getOp() { result = "/=" }
...
/** A compound assignment expression using the `%=` operator. */
class AssignRemExpr extends AssignOp, @java_assignremexpr {
  override string getOp() { result = "%=" }
...
/** A compound assignment expression using the `&=` operator. */
class AssignAndExpr extends AssignOp, @java_assignandexpr {
  override string getOp() { result = "&=" }
...
/** A compound assignment expression using the `|=` operator. */
class AssignOrExpr extends AssignOp, @java_assignorexpr {
  override string getOp() { result = "|=" }
...
/** A compound assignment expression using the `^=` operator. */
class AssignXorExpr extends AssignOp, @java_assignxorexpr {
  override string getOp() { result = "^=" }
...
/** A compound assignment expression using the `<<=` operator. */
class AssignLShiftExpr extends AssignOp, @java_assignlshiftexpr {
  override string getOp() { result = "<<=" }
...
/** A compound assignment expression using the `>>=` operator. */
class AssignRShiftExpr extends AssignOp, @java_assignrshiftexpr {
  override string getOp() { result = ">>=" }
...
/** A compound assignment expression using the `>>>=` operator. */
class AssignURShiftExpr extends AssignOp, @java_assignurshiftexpr {
  override string getOp() { result = ">>>=" }
...
class Literal extends Expr, @java_literal {
  /** Gets a string representation of this literal. */
  string getLiteral() { java_namestrings(result, _, this) }

  /** Gets a string representation of the value of this literal. */
  string getValue() { java_namestrings(_, result, this) }
...
class BooleanLiteral extends Literal, @java_booleanliteral {
...
class IntegerLiteral extends Literal, @java_integerliteral {
...
class NullLiteral extends Literal, @java_nullliteral {
...
class BinaryExpr extends Expr, @java_binaryexpr {
...
class MulExpr extends BinaryExpr, @java_mulexpr {
  override string getOp() { result = " * " }
...
/** A binary expression using the `/` operator. */
class DivExpr extends BinaryExpr, @java_divexpr {
  override string getOp() { result = " / " }
...
/** A binary expression using the `%` operator. */
class RemExpr extends BinaryExpr, @java_remexpr {
  override string getOp() { result = " % " }
...
/** A binary expression using the `+` operator. */
class AddExpr extends BinaryExpr, @java_addexpr {
  override string getOp() { result = " + " }
...
/** A binary expression using the `-` operator. */
class SubExpr extends BinaryExpr, @java_subexpr {
  override string getOp() { result = " - " }
...
/** A binary expression using the `<<` operator. */
class LShiftExpr extends BinaryExpr, @java_lshiftexpr {
  override string getOp() { result = " << " }
...
/** A binary expression using the `>>` operator. */
class RShiftExpr extends BinaryExpr, @java_rshiftexpr {
  override string getOp() { result = " >> " }
...
/** A binary expression using the `>>>` operator. */
class URShiftExpr extends BinaryExpr, @java_urshiftexpr {
  override string getOp() { result = " >>> " }
...
/** A binary expression using the `&` operator. */
class AndBitwiseExpr extends BinaryExpr, @java_andbitexpr {
  override string getOp() { result = " & " }
...
/** A binary expression using the `|` operator. */
class OrBitwiseExpr extends BinaryExpr, @java_orbitexpr {
  override string getOp() { result = " | " }
...
/** A binary expression using the `^` operator. */
class XorBitwiseExpr extends BinaryExpr, @java_xorbitexpr {
  override string getOp() { result = " ^ " }
...
/** A binary expression using the `&&` operator. */
class AndLogicalExpr extends BinaryExpr, @java_andlogicalexpr {
  override string getOp() { result = " && " }
...
/** A binary expression using the `||` operator. */
class OrLogicalExpr extends BinaryExpr, @java_orlogicalexpr {
  override string getOp() { result = " || " }
...
/** A binary expression using the `<` operator. */
class LTExpr extends BinaryExpr, @java_ltexpr {
  override string getOp() { result = " < " }
...
/** A binary expression using the `>` operator. */
class GTExpr extends BinaryExpr, @java_gtexpr {
  override string getOp() { result = " > " }
...
/** A binary expression using the `<=` operator. */
class LEExpr extends BinaryExpr, @java_leexpr {
  override string getOp() { result = " <= " }
...
/** A binary expression using the `>=` operator. */
class GEExpr extends BinaryExpr, @java_geexpr {
  override string getOp() { result = " >= " }
...
/** A binary expression using the `==` operator. */
class EQExpr extends BinaryExpr, @java_eqexpr {
  override string getOp() { result = " == " }
...
/** A binary expression using the `!=` operator. */
class NEExpr extends BinaryExpr, @java_neexpr {
  override string getOp() { result = " != " }
...
class UnaryExpr extends Expr, @java_unaryexpr {
 ...
 */
class UnaryAssignExpr extends UnaryExpr, @java_unaryassignment { }

/** A post-increment expression. For example, `i++`. */
class PostIncExpr extends UnaryAssignExpr, @java_postincexpr {
  override string toString() { result = "...++" }
...
class PostDecExpr extends UnaryAssignExpr, @java_postdecexpr {
  override string toString() { result = "...--" }
...
class PreIncExpr extends UnaryAssignExpr, @java_preincexpr {
  override string toString() { result = "++..." }
...
class PreDecExpr extends UnaryAssignExpr, @java_predecexpr {
  override string toString() { result = "--..." }
...
class MinusExpr extends UnaryExpr, @java_minusexpr {
  override string toString() { result = "-..." }
...
class PlusExpr extends UnaryExpr, @java_plusexpr {
  override string toString() { result = "+..." }
...
class BitNotExpr extends UnaryExpr, @java_bitnotexpr {
  override string toString() { result = "~..." }
...
class LogNotExpr extends UnaryExpr, @java_lognotexpr {
  override string toString() { result = "!..." }
...
/** A cast expression. */
class CastExpr extends Expr, @java_castexpr {
...
class ClassInstanceExpr extends Expr, ConstructorCall, @java_classinstancexpr {
  ...
  override Constructor getConstructor() { java_callableBinding(this, result) }

  /** Gets the anonymous class created by this class instance creation expression, if any. */
  AnonymousClass getAnonymousClass() { java_isAnonymClass(result, this) }
 ...
 */
class LambdaExpr extends FunctionalExpr, @java_lambdaexpr {
  /**
  ...
  predicate hasExprBody() { java_lambdaKind(this, 0) }

  /** Holds if the body of this lambda is a statement. */
  predicate hasStmtBody() { java_lambdaKind(this, 1) }
 ...
 */
class MemberRefExpr extends FunctionalExpr, @java_memberref {
  /**
   ...
   */
  Callable getReferencedCallable() { java_memberRefBinding(this, result) }
 ...
 */
class ConditionalExpr extends Expr, @java_conditionalexpr {
 ...
 * A `switch` expression.
 */
class SwitchExpr extends Expr, @java_switchexpr {
 ...
 */
deprecated class ParExpr extends Expr, @java_parexpr {
...
class InstanceOfExpr extends Expr, @java_instanceofexpr {
 ...
 */
class LocalVariableDeclExpr extends Expr, @java_localvariabledeclexpr {
  /** Gets an access to the variable declared by this local variable declaration expression. */
  VarAccess getAnAccess() { java_variableBinding(result, this.getVariable()) }

  /** Gets the local variable declared by this local variable declaration expression. */
  LocalVariableDecl getVariable() { java_localvars(result, _, _, this) }
...
class TypeLiteral extends Expr, @java_typeliteral {
 ...
 * of type `A`.
 */
class ThisAccess extends InstanceAccess, @java_thisaccess {
  /** Gets a printable representation of this expression. */
 ...
 */
class SuperAccess extends InstanceAccess, @java_superaccess {
  /** Gets a printable representation of this expression. */
  override string toString() {
 ...
 */
class VarAccess extends Expr, @java_varaccess {
  ...
  Variable getVariable() { java_variableBinding(this, result) }
...
class MethodAccess extends Expr, Call, @java_methodaccess {
  ...
  override Expr getArgument(int index) { java_exprs(result, _, _, this, index) and index >= 0 }
  ...
  Method getMethod() { java_callableBinding(this, result) }
...
class TypeAccess extends Expr, Annotatable, @java_typeaccess {
...
class ArrayTypeAccess extends Expr, @java_arraytypeaccess {
  /**
 ...
 */
class UnionTypeAccess extends Expr, @java_uniontypeaccess {
 ...
 */
class IntersectionTypeAccess extends Expr, @java_intersectiontypeaccess {
  /**
...
/** A package access. */
class PackageAccess extends Expr, @java_packageaccess {
  /** Gets a printable representation of this expression. */
...
class WildcardTypeAccess extends Expr, @java_wildcardtypeaccess {
 ...
 */
class Call extends Top, @java_caller {
  ...
  Callable getCallee() { java_callableBinding(this, result) }
