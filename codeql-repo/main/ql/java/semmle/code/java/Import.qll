...
class Import extends Element, @java_import {
...
class ImportType extends Import {
  ImportType() { java_imports(this, _, _, 1) }

  /** Gets the imported type. */
  RefType getImportedType() { java_imports(this, result, _, _) }
...
class ImportOnDemandFromType extends Import {
  ImportOnDemandFromType() { java_imports(this, _, _, 2) }

  /** Gets the type from which accessible nested types are imported. */
  RefType getTypeHoldingImport() { java_imports(this, result, _, _) }
...
class ImportOnDemandFromPackage extends Import {
  ImportOnDemandFromPackage() { java_imports(this, _, _, 3) }

  /** Gets the package from which accessible types are imported. */
  Package getPackageHoldingImport() { java_imports(this, result, _, _) }
...
class ImportStaticOnDemand extends Import {
  ImportStaticOnDemand() { java_imports(this, _, _, 4) }
