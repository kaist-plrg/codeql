...
/**
 * A JUnit `@java_Ignore` annotation.
 */
...
/**
 * A method which, directly or indirectly, is treated as ignored by JUnit due to a `@java_Ignore`
 * annotation.
 */
...
/**
 * A `@java_Category` annotation on a class or method, that categorizes the annotated test.
 */
