...
class Stmt extends StmtParent, ExprParent, @java_stmt {
   ...
   */
  Callable getEnclosingCallable() { java_stmts(this, _, _, _, result) }

  /** Gets the index of this statement as a child of its parent. */
  int getIndex() { java_stmts(this, _, _, result, _) }

  /** Gets the parent of this statement. */
  StmtParent getParent() { java_stmts(this, _, result, _, _) }
...
class StmtParent extends @java_stmtparent, Top { }

/** A block of statements. */
class BlockStmt extends Stmt, @java_block {
...
/** An `if` statement. */
class IfStmt extends ConditionalStmt, @java_ifstmt {
...
/** A `for` loop. */
class ForStmt extends ConditionalStmt, @java_forstmt {
  /**
...
class EnhancedForStmt extends Stmt, @java_enhancedforstmt {
...
/** A `while` loop. */
class WhileStmt extends ConditionalStmt, @java_whilestmt {
...
/** A `do` loop. */
class DoStmt extends ConditionalStmt, @java_dostmt {
...
/** A `try` statement. */
class TryStmt extends Stmt, @java_trystmt {
...
class CatchClause extends Stmt, @java_catchclause {
...
/** A `switch` statement. */
class SwitchStmt extends Stmt, @java_switchstmt {
 ...
 */
class SwitchCase extends Stmt, @java_case {
...
class SynchronizedStmt extends Stmt, @java_synchronizedstmt {
...
/** A `return` statement. */
class ReturnStmt extends Stmt, @java_returnstmt {
...
/** A `throw` statement. */
class ThrowStmt extends Stmt, @java_throwstmt {
...
class JumpStmt extends Stmt {
  ...
  LabeledStmt getTargetLabel() {
    ...
    java_namestrings(result.getLabel(), _, this)
  }
...
/** A `break` statement. */
class BreakStmt extends Stmt, @java_breakstmt {
  /** Gets the label targeted by this `break` statement, if any. */
  string getLabel() { java_namestrings(result, _, this) }
 ...
 * A `yield` statement.
 */
class YieldStmt extends Stmt, @java_yieldstmt {
  /**
...
class ContinueStmt extends Stmt, @java_continuestmt {
...
/** The empty statement. */
class EmptyStmt extends Stmt, @java_emptystmt {
  /** Gets a printable representation of this statement. May include more detail than `toString()`. */
  override string pp() { result = ";" }
 ...
 */
class ExprStmt extends Stmt, @java_exprstmt {
...
/** A labeled statement. */
class LabeledStmt extends Stmt, @java_labeledstmt {
...
/** An `assert` statement. */
class AssertStmt extends Stmt, @java_assertstmt {
  /** Gets the boolean expression of this `assert` statement. */
  Expr getExpr() { java_exprs(result, _, _, this, _) and result.getIndex() = 0 }

  /** Gets the assertion message expression, if any. */
  Expr getMessage() { java_exprs(result, _, _, this, _) and result.getIndex() = 1 }
...
class LocalVariableDeclStmt extends Stmt, @java_localvariabledeclstmt {
...
class LocalClassDeclStmt extends Stmt, @java_localclassdeclstmt {
  /** Gets the local class declared by this statement. */
  LocalClass getLocalClass() { java_isLocalClass(result, this) }
...
class ThisConstructorInvocationStmt extends Stmt, ConstructorCall, @java_constructorinvocationstmt {
...
class SuperConstructorInvocationStmt extends Stmt, ConstructorCall, @java_superconstructorinvocationstmt {
  /** Gets an argument of this constructor invocation. */
  override Expr getAnArgument() { result.getIndex() >= 0 and result.getParent() = this }
