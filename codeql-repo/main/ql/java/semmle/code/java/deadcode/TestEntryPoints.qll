...
/**
 * Any types used as a category in a JUnit `@java_Category` annotation should be considered live.
 */
...
/**
 * A `@java_DataProvider` TestNG method which is live because it is accessed by at least one test.
 */
...
/**
 * A `@java_Factory` TestNG method or constructor which is live.
 */
