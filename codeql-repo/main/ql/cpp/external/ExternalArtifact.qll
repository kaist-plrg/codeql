 ...
 */
class ExternalData extends @cpp_externalDataElement {
  /** Gets the path of the file this data was loaded from. */
  string getDataPath() { cpp_externalData(this, result, _, _) }
  ...
  int getNumFields() { result = 1 + max(int i | cpp_externalData(this, _, i, _) | i) }

  /** Gets the value of the `i`th field of this data item. */
  string getField(int i) { cpp_externalData(this, _, i, result) }
