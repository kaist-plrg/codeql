...
class Parameter extends LocalScopeVariable, @cpp_parameter {
  ...
  override Function getFunction() {
    cpp_params(underlyingElement(this), unresolveElement(result), _, _)
  }
   ...
   * block parameter.
   */
  BlockStmt getCatchBlock() { cpp_params(underlyingElement(this), unresolveElement(result), _, _) }
   ...
   */
  int getIndex() { cpp_params(underlyingElement(this), _, result, _) }
   ...
   */
  override Type getType() { cpp_params(underlyingElement(this), _, _, unresolveElement(result)) }
