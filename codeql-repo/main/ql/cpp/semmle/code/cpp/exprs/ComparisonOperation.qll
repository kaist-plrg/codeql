 ...
 */
class ComparisonOperation extends BinaryOperation, @cpp_cmp_op_expr { }

/**
 * A C/C++ equality operation, that is, either "==" or "!=".
 */
class EqualityOperation extends ComparisonOperation, @cpp_eq_op_expr {
 ...
 * ```
 */
class EQExpr extends EqualityOperation, @cpp_eqexpr {
 ...
 * ```
 */
class NEExpr extends EqualityOperation, @cpp_neexpr {
 ...
 */
class RelationalOperation extends ComparisonOperation, @cpp_rel_op_expr {
 ...
 * ```
 */
class GTExpr extends RelationalOperation, @cpp_gtexpr {
 ...
 * ```
 */
class LTExpr extends RelationalOperation, @cpp_ltexpr {
 ...
 * ```
 */
class GEExpr extends RelationalOperation, @cpp_geexpr {
 ...
 * ```
 */
class LEExpr extends RelationalOperation, @cpp_leexpr {
