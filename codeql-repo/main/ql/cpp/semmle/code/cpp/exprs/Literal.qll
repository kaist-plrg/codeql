 ...
 */
class Literal extends Expr, @cpp_literal {
...
class LabelLiteral extends Literal {
  LabelLiteral() { cpp_jumpinfo(underlyingElement(this), _, _) }

  override string getAPrimaryQlClass() { result = "LabelLiteral" }

  /** Gets the corresponding label statement. */
  LabelStmt getLabel() { cpp_jumpinfo(underlyingElement(this), _, unresolveElement(result)) }
}
...
class TextLiteral extends Literal {
  TextLiteral() {
    ...
    // @cpp_aggregateliteral rather than @cpp_literal.
 ...
 */
class AggregateLiteral extends Expr, @cpp_aggregateliteral {
...
class ClassAggregateLiteral extends AggregateLiteral {
  ...
  Expr getFieldExpr(Field field) {
    ...
    cpp_aggregate_field_init(underlyingElement(this), unresolveElement(result), unresolveElement(field))
  }
...
class ArrayOrVectorAggregateLiteral extends AggregateLiteral {
  ...
  Expr getElementExpr(int elementIndex) {
    cpp_aggregate_array_init(underlyingElement(this), unresolveElement(result), elementIndex)
  }
