...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C `@cpp_selector` expression, for example `@cpp_selector(driveForDistance:)`.
 */
deprecated class AtSelectorExpr extends Expr {
  ...
  /**
   * Gets the selector of this `@cpp_selector` expression, for example `driveForDistance:`.
   */
  string getSelector() { none() }
}
...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C `@cpp_protocol` expression, for example `@cpp_protocol(SomeProtocol)`.
 */
deprecated class AtProtocolExpr extends Expr {
  ...
  /**
   * Gets the protocol of this `@cpp_protocol` expression, for example `SomeProtocol`.
   */
...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C `@cpp_encode` expression, for example `@cpp_encode(int *)`.
 */
deprecated class AtEncodeExpr extends Expr {
  ...
  /**
   * Gets the type this `@cpp_encode` expression encodes, for example `int *`.
   */
...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C @cpp_ expression which boxes a single value, such as @cpp_(22).
 */
...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C @cpp_"..." string literal.
 */
