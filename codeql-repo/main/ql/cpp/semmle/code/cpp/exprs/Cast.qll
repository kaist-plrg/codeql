 ...
 */
class Conversion extends Expr, @cpp_conversion {
 ...
 */
class Cast extends Conversion, @cpp_cast {
  /**
 ...
 * ```
 */
class CStyleCast extends Cast, @cpp_c_style_cast {
 ...
 * ```
 */
class StaticCast extends Cast, @cpp_static_cast {
 ...
 * ```
 */
class ConstCast extends Cast, @cpp_const_cast {
 ...
 * ```
 */
class ReinterpretCast extends Cast, @cpp_reinterpret_cast {
...
class ArithmeticConversion extends Cast {
  ArithmeticConversion() {
    cpp_conversionkinds(underlyingElement(this), 0) and
...
class BoolConversion extends Cast {
  BoolConversion() { cpp_conversionkinds(underlyingElement(this), 1) }
...
class InheritanceConversion extends Cast {
  InheritanceConversion() {
    cpp_conversionkinds(underlyingElement(this), 2) or cpp_conversionkinds(underlyingElement(this), 3)
  }
...
class BaseClassConversion extends InheritanceConversion {
  BaseClassConversion() { cpp_conversionkinds(underlyingElement(this), 2) }
...
class DerivedClassConversion extends InheritanceConversion {
  DerivedClassConversion() { cpp_conversionkinds(underlyingElement(this), 3) }
...
class PointerToMemberBaseClassConversion extends Cast {
  PointerToMemberBaseClassConversion() { cpp_conversionkinds(underlyingElement(this), 4) }
...
class PointerToMemberDerivedClassConversion extends Cast {
  PointerToMemberDerivedClassConversion() { cpp_conversionkinds(underlyingElement(this), 5) }
...
class GlvalueConversion extends Cast {
  GlvalueConversion() { cpp_conversionkinds(underlyingElement(this), 6) }
...
class PrvalueAdjustmentConversion extends Cast {
  PrvalueAdjustmentConversion() { cpp_conversionkinds(underlyingElement(this), 7) }
 ...
 * ```
 */
class DynamicCast extends Cast, @cpp_dynamic_cast {
 ...
 * ```
 */
class UuidofOperator extends Expr, @cpp_uuidof {
  ...
  Type getTypeOperand() { cpp_uuidof_bind(underlyingElement(this), unresolveElement(result)) }
}
 ...
 * ```
 */
class TypeidOperator extends Expr, @cpp_type_id {
  /**
   * Gets the type that is returned by this typeid expression.
   */
  Type getResultType() { cpp_typeid_bind(underlyingElement(this), unresolveElement(result)) }
 ...
 * ```
 */
class SizeofPackOperator extends Expr, @cpp_sizeof_pack {
 ...
 */
class SizeofOperator extends Expr, @cpp_runtime_sizeof {
  override int getPrecedence() { result = 16 }
}
...
class SizeofTypeOperator extends SizeofOperator {
  SizeofTypeOperator() { cpp_sizeof_bind(underlyingElement(this), _) }

  override string getAPrimaryQlClass() { result = "SizeofTypeOperator" }

  /** Gets the contained type. */
  Type getTypeOperand() { cpp_sizeof_bind(underlyingElement(this), unresolveElement(result)) }
 ...
 */
class AlignofOperator extends Expr, @cpp_runtime_alignof {
  override int getPrecedence() { result = 16 }
}
...
class AlignofTypeOperator extends AlignofOperator {
  AlignofTypeOperator() { cpp_sizeof_bind(underlyingElement(this), _) }
 ...
 * or `ReinterpretCast` for more information.
 */
class ArrayToPointerConversion extends Conversion, @cpp_array_to_pointer {
 ...
 * ```
 */
class TemporaryObjectExpr extends Conversion, @cpp_temp_init {
  /** Gets a textual representation of this conversion. */
