 ...
 */
class Expr extends StmtParent, @cpp_expr {
  /** Gets the nth child of this expression. */
  Expr getChild(int n) { cpp_exprparents(unresolveElement(result), n, underlyingElement(this)) }
  ...
  Element getParent() { cpp_exprparents(underlyingElement(this), _, unresolveElement(result)) }
  ...
  private Location getDbLocation() { cpp_exprs(underlyingElement(this), _, result) }

  /** Holds if this is an auxiliary expression generated by the compiler. */
  predicate isCompilerGenerated() {
    cpp_compgenerated(underlyingElement(this)) or
  ...
  pragma[nomagic]
  cached
  Type getType() { cpp_expr_types(underlyingElement(this), unresolveElement(result), _) }
   ...
   */
  deprecated int getKind() { cpp_exprs(underlyingElement(this), result, _) }
  ...
  string getValue() {
    exists(@cpp_value v | cpp_values(v, result) and cpp_valuebind(v, underlyingElement(this)))
  }

  /** Gets the value text of this expression that's in the database. */
  private string getDbValueText() {
    exists(@cpp_value v | cpp_valuebind(v, underlyingElement(this)) and cpp_valuetext(v, result))
  }
  ...
  predicate isConstant() {
    cpp_valuebind(_, underlyingElement(this))
    or
   ...
   */
  predicate isLValueCategory() { cpp_expr_types(underlyingElement(this), _, 3) }
   ...
   */
  predicate isXValueCategory() { cpp_expr_types(underlyingElement(this), _, 2) }
   ...
   */
  predicate isPRValueCategory() { cpp_expr_types(underlyingElement(this), _, 1) }
   ...
   */
  predicate hasLValueToRValueConversion() { cpp_expr_isload(underlyingElement(this)) }
  ...
  predicate hasConversion() {
    exists(Expr e | cpp_exprconv(underlyingElement(this), unresolveElement(e)))
  }
  ...
  predicate hasImplicitConversion() {
    exists(Expr e |
      cpp_exprconv(underlyingElement(this), unresolveElement(e)) and e.(Conversion).isImplicit()
    )
  }
  ...
  predicate hasExplicitConversion() {
    exists(Expr e |
      cpp_exprconv(underlyingElement(this), unresolveElement(e)) and not e.(Conversion).isImplicit()
    )
  }
   ...
   */
  Expr getConversion() { cpp_exprconv(underlyingElement(this), unresolveElement(result)) }
 ...
 */
class Operation extends Expr, @cpp_op_expr {
 ...
 */
class UnaryOperation extends Operation, @cpp_un_op_expr {
 ...
 */
class BinaryOperation extends Operation, @cpp_bin_op_expr {
 ...
 * ```
 */
class ParenthesizedBracedInitializerList extends Expr, @cpp_braced_init_list {
 ...
 * ```
 */
class ParenthesisExpr extends Conversion, @cpp_parexpr {
  override string toString() { result = "(...)" }
 ...
 */
class ErrorExpr extends Expr, @cpp_errorexpr {
 ...
 * ```
 */
class AssumeExpr extends Expr, @cpp_assume {
 ...
 * ```
 */
class CommaExpr extends Expr, @cpp_commaexpr {
 ...
 * ```
 */
class AddressOfExpr extends UnaryOperation, @cpp_address_of {
 ...
 * ```
 */
class ReferenceToExpr extends Conversion, @cpp_reference_to {
 ...
 * ```
 */
class PointerDereferenceExpr extends UnaryOperation, @cpp_indirect {
 ...
 * ```
 */
class ReferenceDereferenceExpr extends Conversion, @cpp_ref_indirect {
 ...
 */
class NewOrNewArrayExpr extends Expr, @cpp_any_new_expr {
  override int getPrecedence() { result = 16 }

  /**
   * Gets the `operator new` or `operator new[]` that allocates storage.
   */
  Function getAllocator() { cpp_expr_allocator(underlyingElement(this), unresolveElement(result), _) }

  /**
   * Holds if the allocation function is the version that expects an alignment
   * argument of type `std::align_val_t`.
   */
  predicate hasAlignedAllocation() { cpp_expr_allocator(underlyingElement(this), _, 1) }
  ...
  Function getDeallocator() {
    cpp_expr_deallocator(underlyingElement(this), unresolveElement(result), _)
  }
  ...
  predicate hasSizedDeallocation() {
    exists(int form |
      cpp_expr_deallocator(underlyingElement(this), _, form) and
 ...
 * ```
 */
class NewExpr extends NewOrNewArrayExpr, @cpp_new_expr {
  ...
  override Type getAllocatedType() {
    cpp_new_allocated_type(underlyingElement(this), unresolveElement(result))
  }
 ...
 * ```
 */
class NewArrayExpr extends NewOrNewArrayExpr, @cpp_new_array_expr {
  override string toString() { result = "new[]" }
   ...
   */
  override Type getAllocatedType() {
    cpp_new_array_allocated_type(underlyingElement(this), unresolveElement(result))
  }
 ...
 * ```
 */
class DeleteExpr extends Expr, @cpp_delete_expr {
 ...
 * ```
 */
class DeleteArrayExpr extends Expr, @cpp_delete_array_expr {
  override string toString() { result = "delete[]" }
 ...
 * ```
 */
class StmtExpr extends Expr, @cpp_expr_stmt {
 ...
 * A C++ `this` expression.
 */
class ThisExpr extends Expr, @cpp_thisaccess {
...
class BlockExpr extends Literal {
  BlockExpr() { cpp_code_block(underlyingElement(this), _) }
   ...
   */
  Function getFunction() { cpp_code_block(underlyingElement(this), unresolveElement(result)) }
}
 ...
 * ```
 */
class ThrowExpr extends Expr, @cpp_throw_expr {
  /**
 ...
 * ```
 */
class NoExceptExpr extends Expr, @cpp_noexceptexpr {
 ...
 * ```
 */
class FoldExpr extends Expr, @cpp_foldexpr {
  ...
  string getOperatorString() { cpp_fold(underlyingElement(this), result, _) }

  /** Holds if this is a left-fold expression. */
  predicate isLeftFold() { cpp_fold(underlyingElement(this), _, true) }

  /** Holds if this is a right-fold expression. */
  predicate isRightFold() { cpp_fold(underlyingElement(this), _, false) }
...
private predicate convparents(Expr child, int idx, Element parent) {
  ...
  exists(Expr astChild |
    cpp_exprparents(unresolveElement(astChild), idx, unresolveElement(parent)) and
 ...
 * ```
 */
class SpaceshipExpr extends BinaryOperation, @cpp_spaceshipexpr {
 ...
 * ```
 */
class CoAwaitExpr extends UnaryOperation, @cpp_co_await {
 ...
 * ```
 */
class CoYieldExpr extends UnaryOperation, @cpp_co_yield {
