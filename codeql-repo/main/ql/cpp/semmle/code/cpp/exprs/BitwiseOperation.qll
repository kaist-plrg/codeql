 ...
 */
class UnaryBitwiseOperation extends UnaryOperation, @cpp_un_bitwise_op_expr { }
 ...
 * ```
 */
class ComplementExpr extends UnaryBitwiseOperation, @cpp_complementexpr {
 ...
 */
class BinaryBitwiseOperation extends BinaryOperation, @cpp_bin_bitwise_op_expr { }
 ...
 * ```
 */
class LShiftExpr extends BinaryBitwiseOperation, @cpp_lshiftexpr {
  override string getOperator() { result = "<<" }
 ...
 * ```
 */
class RShiftExpr extends BinaryBitwiseOperation, @cpp_rshiftexpr {
  override string getOperator() { result = ">>" }
 ...
 * ```
 */
class BitwiseAndExpr extends BinaryBitwiseOperation, @cpp_andexpr {
  override string getOperator() { result = "&" }
 ...
 * ```
 */
class BitwiseOrExpr extends BinaryBitwiseOperation, @cpp_orexpr {
  override string getOperator() { result = "|" }
 ...
 * ```
 */
class BitwiseXorExpr extends BinaryBitwiseOperation, @cpp_xorexpr {
  override string getOperator() { result = "^" }
