 ...
 * ```
 */
class Include extends PreprocessorDirective, @cpp_ppd_include {
  ...
  File getIncludedFile() { cpp_includes(underlyingElement(this), unresolveElement(result)) }
 ...
 * ```
 */
class IncludeNext extends Include, @cpp_ppd_include_next {
 ...
 * ```
 */
class Import extends Include, @cpp_ppd_objc_import {
