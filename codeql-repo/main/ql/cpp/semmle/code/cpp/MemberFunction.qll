...
class MemberFunction extends Function {
  ...
  predicate overrides(MemberFunction that) {
    cpp_overrides(underlyingElement(this), unresolveElement(that))
  }
  ...
  PointerType getTypeOfThis() {
    cpp_member_function_this_type(underlyingElement(this), unresolveElement(result))
  }
}
...
class VirtualFunction extends MemberFunction {
  VirtualFunction() { this.hasSpecifier("virtual") or cpp_purefunctions(underlyingElement(this)) }
...
class PureVirtualFunction extends VirtualFunction {
  PureVirtualFunction() { cpp_purefunctions(underlyingElement(this)) }
...
class Constructor extends MemberFunction {
  Constructor() { cpp_functions(underlyingElement(this), _, 2) }
  ...
  ConstructorInit getInitializer(int i) {
    cpp_exprparents(unresolveElement(result), i, underlyingElement(this))
  }
}
...
class ImplicitConversionFunction extends MemberFunction {
  ImplicitConversionFunction() {
    // ConversionOperator
    cpp_functions(underlyingElement(this), _, 4)
    or
...
class Destructor extends MemberFunction {
  Destructor() { cpp_functions(underlyingElement(this), _, 3) }
...
class ConversionOperator extends MemberFunction, ImplicitConversionFunction {
  ConversionOperator() { cpp_functions(underlyingElement(this), _, 4) }
