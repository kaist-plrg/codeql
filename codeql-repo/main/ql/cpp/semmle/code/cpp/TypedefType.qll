...
class TypedefType extends UserType {
  TypedefType() {
    cpp_usertypes(underlyingElement(this), _, 5) or
    cpp_usertypes(underlyingElement(this), _, 14)
  }

  /**
   * Gets the base type of this typedef type.
   */
  Type getBaseType() { cpp_typedefbase(underlyingElement(this), unresolveElement(result)) }
...
class CTypedefType extends TypedefType {
  CTypedefType() { cpp_usertypes(underlyingElement(this), _, 5) }
...
class UsingAliasTypedefType extends TypedefType {
  UsingAliasTypedefType() { cpp_usertypes(underlyingElement(this), _, 14) }
