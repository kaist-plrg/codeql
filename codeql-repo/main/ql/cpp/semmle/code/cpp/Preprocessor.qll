 ...
 */
class PreprocessorDirective extends Locatable, @cpp_preprocdirect {
  override string toString() { result = "Preprocessor directive" }

  override Location getLocation() { cpp_preprocdirects(underlyingElement(this), _, result) }

  string getHead() { cpp_preproctext(underlyingElement(this), result, _) }
...
private class TPreprocessorBranchDirective = @cpp_ppd_branch or @cpp_ppd_else or @cpp_ppd_endif;
...
class PreprocessorBranchDirective extends PreprocessorDirective, TPreprocessorBranchDirective {
  ...
  PreprocessorBranch getIf() {
    ...
    cpp_preprocpair(unresolveElement(result), underlyingElement(this))
  }
   ...
   * one result.
   */
  PreprocessorEndif getEndIf() { cpp_preprocpair(unresolveElement(getIf()), unresolveElement(result)) }
 ...
 */
class PreprocessorBranch extends PreprocessorBranchDirective, @cpp_ppd_branch {
  /**
   * Holds if at least one translation unit evaluated this directive's
   * condition and subsequently took the branch.
   */
  predicate wasTaken() { cpp_preproctrue(underlyingElement(this)) }
   ...
   */
  predicate wasNotTaken() { cpp_preprocfalse(underlyingElement(this)) }
 ...
 * `PreprocessorBranch`.
 */
class PreprocessorIf extends PreprocessorBranch, @cpp_ppd_if {
 ...
 */
class PreprocessorIfdef extends PreprocessorBranch, @cpp_ppd_ifdef {
 ...
 */
class PreprocessorIfndef extends PreprocessorBranch, @cpp_ppd_ifndef {
 ...
 */
class PreprocessorElse extends PreprocessorBranchDirective, @cpp_ppd_else {
 ...
 */
class PreprocessorElif extends PreprocessorBranch, @cpp_ppd_elif {
 ...
 */
class PreprocessorEndif extends PreprocessorBranchDirective, @cpp_ppd_endif {
 ...
 */
class PreprocessorWarning extends PreprocessorDirective, @cpp_ppd_warning {
 ...
 */
class PreprocessorError extends PreprocessorDirective, @cpp_ppd_error {
 ...
 */
class PreprocessorUndef extends PreprocessorDirective, @cpp_ppd_undef {
 ...
 */
class PreprocessorPragma extends PreprocessorDirective, @cpp_ppd_pragma {
 ...
 */
class PreprocessorLine extends PreprocessorDirective, @cpp_ppd_line {
