 ...
 */
class Declaration extends Locatable, @cpp_declaration {
  /**
  ...
  private Type getTemplateArgumentType(int index) {
    cpp_class_template_argument(underlyingElement(this), index, unresolveElement(result))
    or
    cpp_function_template_argument(underlyingElement(this), index, unresolveElement(result))
    or
    cpp_variable_template_argument(underlyingElement(this), index, unresolveElement(result))
  }

  private Expr getTemplateArgumentValue(int index) {
    cpp_class_template_argument_value(underlyingElement(this), index, unresolveElement(result))
    or
    cpp_function_template_argument_value(underlyingElement(this), index, unresolveElement(result))
    or
    cpp_variable_template_argument_value(underlyingElement(this), index, unresolveElement(result))
  }
}

private class TDeclarationEntry = @cpp_var_decl or @cpp_type_decl or @cpp_fun_decl;
...
private class TAccessHolder = @cpp_function or @cpp_usertype;
