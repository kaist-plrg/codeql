...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C `@cpp_autoreleasepool` statement, for example
 * `@cpp_autoreleasepool { int x; int y; }`.
 */
deprecated class AutoReleasePoolStmt extends Stmt {
  ...
  /** Gets the body statement of this `@cpp_autoreleasepool` statement. */
  Stmt getStmt() { none() }
...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C `@cpp_synchronized statement`, for example
 * `@cpp_synchronized (x) { [x complicationOperation]; }`.
 */
deprecated class SynchronizedStmt extends Stmt {
  ...
  /** Gets the body statement of this `@cpp_synchronized` statement. */
  Stmt getStmt() { none() }
}
...
/**
 * DEPRECATED: Objective-C is no longer supported.
 * An Objective C `@cpp_finally` block.
 */
...
deprecated class Property extends Declaration {
   ...
   *
   * For the attribute list following the `@cpp_property` keyword, use
   * `getAnAttribute()`.
   */
   ...
   * property was explicitly or automatically `@cpp_synthesize`d).
   */
