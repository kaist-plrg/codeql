 ...
 * ```
 */
class NameQualifier extends NameQualifiableElement, @cpp_namequalifier {
  /**
  ...
  override Location getLocation() { cpp_namequalifiers(underlyingElement(this), _, _, result) }
  ...
  override NameQualifier getNameQualifier() {
    cpp_namequalifiers(unresolveElement(result), underlyingElement(this), _, _)
  }
  ...
  NameQualifiableElement getQualifiedElement() {
    cpp_namequalifiers(underlyingElement(this), unresolveElement(result), _, _)
  }
  ...
  NameQualifyingElement getQualifyingElement() {
    exists(NameQualifyingElement nqe |
      cpp_namequalifiers(underlyingElement(this), _, unresolveElement(nqe), _) and
 ...
 * ```
 */
class NameQualifiableElement extends Element, @cpp_namequalifiableelement {
  /**
  ...
  predicate hasSuperQualifiedName() {
    exists(NameQualifier nq, SpecialNameQualifyingElement snqe |
      ...
      cpp_namequalifiers(unresolveElement(nq), _, unresolveElement(snqe), _) and
 ...
 * ```
 */
class NameQualifyingElement extends Element, @cpp_namequalifyingelement {
  /**
  ...
  NameQualifier getANameQualifier() {
    cpp_namequalifiers(unresolveElement(result), _, underlyingElement(this), _)
  }
...
library class SpecialNameQualifyingElement extends NameQualifyingElement,
  ...
  override string getName() { cpp_specialnamequalifyingelements(underlyingElement(this), result) }
