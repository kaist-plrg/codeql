...
class MetricFunction extends Function {
  ...
  int getNumberOfLines() { cpp_numlines(underlyingElement(this), result, _, _) }

  /** Gets the number of lines of code in this function. */
  int getNumberOfLinesOfCode() { cpp_numlines(underlyingElement(this), _, result, _) }

  /** Gets the number of lines of comments in this function. */
  int getNumberOfLinesOfComments() { cpp_numlines(underlyingElement(this), _, _, result) }
