 ...
 * A C/C++ statement.
 */
class Stmt extends StmtParent, @cpp_stmt {
  /** Gets the `n`th child of this statement. */
  Element getChild(int n) {
    cpp_stmtparents(unresolveElement(result), n, underlyingElement(this)) or
    cpp_exprparents(unresolveElement(result), n, underlyingElement(this))
  }
  ...
  StmtParent getParent() { cpp_stmtparents(underlyingElement(this), _, unresolveElement(result)) }

  /** Gets the parent statement of this statement, if any. */
  Stmt getParentStmt() { cpp_stmtparents(underlyingElement(this), _, unresolveElement(result)) }
  ...
  override Location getLocation() { cpp_stmts(underlyingElement(this), _, result) }
   ...
   */
  deprecated int getKind() { cpp_stmts(underlyingElement(this), result, _) }
   ...
   * `[[clang::fallthrough]]`.
   */
  Attribute getAnAttribute() { cpp_stmtattributes(underlyingElement(this), unresolveElement(result)) }
...
private class TStmtParent = @cpp_stmt or @cpp_expr;
 ...
 */
class ExprStmt extends Stmt, @cpp_stmt_expr {
...
private class TConditionalStmt = @cpp_stmt_if or @cpp_stmt_constexpr_if or @cpp_stmt_switch;
 ...
 * ```
 */
class IfStmt extends ConditionalStmt, @cpp_stmt_if {
   ...
   */
  Stmt getThen() { cpp_if_then(underlyingElement(this), unresolveElement(result)) }
   ...
   * there is no result.
   */
  Stmt getElse() { cpp_if_else(underlyingElement(this), unresolveElement(result)) }
 ...
 * ```
 */
class ConstexprIfStmt extends ConditionalStmt, @cpp_stmt_constexpr_if {
   ...
   * the result is the `BlockStmt` `{ x = 1; }`.
   */
  Stmt getThen() { cpp_constexpr_if_then(underlyingElement(this), unresolveElement(result)) }
   ...
   * there is no result.
   */
  Stmt getElse() { cpp_constexpr_if_else(underlyingElement(this), unresolveElement(result)) }
...
private class TLoop = @cpp_stmt_while or @cpp_stmt_end_test_while or @cpp_stmt_range_based_for or @cpp_stmt_for;
 ...
 * ```
 */
class WhileStmt extends Loop, @cpp_stmt_while {
  ...
  override Stmt getStmt() { cpp_while_body(underlyingElement(this), unresolveElement(result)) }
 ...
 */
class JumpStmt extends Stmt, @cpp_jump {
  override string getAPrimaryQlClass() { result = "JumpStmt" }

  /** Gets the target of this jump statement. */
  Stmt getTarget() { cpp_jumpinfo(underlyingElement(this), _, unresolveElement(result)) }
}
 ...
 * ```
 */
class GotoStmt extends JumpStmt, @cpp_stmt_goto {
   ...
   */
  string getName() { cpp_jumpinfo(underlyingElement(this), result, _) and result != "" }

  /** Holds if this 'goto' statement refers to a label. */
  predicate hasName() { exists(string s | cpp_jumpinfo(underlyingElement(this), s, _) and s != "") }
 ...
 * ```
 */
class ComputedGotoStmt extends Stmt, @cpp_stmt_assigned_goto {
  /**
 ...
 * ```
 */
class ContinueStmt extends JumpStmt, @cpp_stmt_continue {
 ...
 * ```
 */
class BreakStmt extends JumpStmt, @cpp_stmt_break {
 ...
 * ```
 */
class LabelStmt extends Stmt, @cpp_stmt_label {
 ...
 * ```
 */
class CoReturnStmt extends Stmt, @cpp_stmt_co_return {
 ...
 * ```
 */
class ReturnStmt extends Stmt, @cpp_stmt_return {
 ...
 * ```
 */
class DoStmt extends Loop, @cpp_stmt_end_test_while {
  ...
  override Stmt getStmt() { cpp_do_body(underlyingElement(this), unresolveElement(result)) }
 ...
 */
class RangeBasedForStmt extends Loop, @cpp_stmt_range_based_for {
 ...
 * ```
 */
class ForStmt extends Loop, @cpp_stmt_for {
   ...
   * ```
   */
  Stmt getInitialization() { cpp_for_initialization(underlyingElement(this), unresolveElement(result)) }
   ...
   * ```
   */
  override Expr getCondition() { cpp_for_condition(underlyingElement(this), unresolveElement(result)) }
   ...
   * ```
   */
  Expr getUpdate() { cpp_for_update(underlyingElement(this), unresolveElement(result)) }

  override Stmt getStmt() { cpp_for_body(underlyingElement(this), unresolveElement(result)) }
 ...
 * ```
 */
class SwitchCase extends Stmt, @cpp_stmt_switch_case {
   ...
   * has result 2.
   */
  int getChildNum() { cpp_switch_case(_, result, underlyingElement(this)) }
 ...
 * ```
 */
class SwitchStmt extends ConditionalStmt, @cpp_stmt_switch {
   ...
   * ```
   */
  Stmt getStmt() { cpp_switch_body(underlyingElement(this), unresolveElement(result)) }
   ...
   */
  SwitchCase getASwitchCase() { cpp_switch_case(underlyingElement(this), _, unresolveElement(result)) }
 ...
 * entry to it.
 */
class Handler extends Stmt, @cpp_stmt_handler {
 ...
 * ```
 */
class TryStmt extends Stmt, @cpp_stmt_try_block {
...
class CatchBlock extends BlockStmt {
  ...
  CatchBlock() { cpp_ishandler(underlyingElement(this)) }
 ...
 * C/C++ extension.
 */
class MicrosoftTryStmt extends Stmt, @cpp_stmt_microsoft_try {
 ...
 * ```
 */
class DeclStmt extends Stmt, @cpp_stmt_decl {
  ...
  DeclarationEntry getDeclarationEntry(int i) {
    cpp_stmt_decl_entry_bind(underlyingElement(this), i, unresolveElement(result))
  }
  ...
  Declaration getDeclaration(int i) {
    cpp_stmt_decl_bind(underlyingElement(this), i, unresolveElement(result))
  }
 ...
 * ```
 */
class EmptyStmt extends Stmt, @cpp_stmt_empty {
 ...
 * ```
 */
class AsmStmt extends Stmt, @cpp_stmt_asm {
 ...
 */
class VlaDimensionStmt extends Stmt, @cpp_stmt_set_vla_size {
 ...
 * variable length dimension of the array.
 */
class VlaDeclStmt extends Stmt, @cpp_stmt_vla_decl {
   ...
   * if any.
   */
  Type getType() { cpp_type_vla(unresolveElement(result), underlyingElement(this)) }

  /**
   * Gets the variable that this VLA declaration statement relates to,
   * if any.
   */
  Variable getVariable() { cpp_variable_vla(unresolveElement(result), underlyingElement(this)) }
}
