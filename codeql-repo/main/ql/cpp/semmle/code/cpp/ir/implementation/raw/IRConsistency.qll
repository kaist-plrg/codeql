...
module InstructionConsistency {
    ...
    exists(OperandTag tag |
      ...
      message =
        "Instruction '" + instr.getOpcode().toString() +
          "' is missing an expected operand with tag '" + tag.toString() + "' in function '$@cpp_'." and
    ...
    exists(IRBlock pred |
      ...
      message =
        "Instruction '" + instr.toString() + "' is missing an operand for predecessor block '" +
          pred.toString() + "' in function '$@cpp_'." and
      irFunc = getInstructionIRFunction(instr, irFuncText)
    )
  }
    ...
    exists(Instruction use |
      ...
      message =
        "Operand '" + operand.toString() + "' of instruction '" + use.getOpcode().toString() +
          "' is missing a type in function '$@cpp_'." and
  ...
  query predicate duplicateChiOperand(
    ...
    message =
      "Chi instruction for " + chi.getPartial().toString() +
        " has duplicate operands in function '$@cpp_'." and
  ...
  query predicate sideEffectWithoutPrimary(
    ...
    message =
      "Side effect instruction '" + instr + "' is missing a primary instruction in function '$@cpp_'." and
    irFunc = getInstructionIRFunction(instr, irFuncText)
  }
  ...
  query predicate instructionWithoutSuccessor(
    ...
    message = "Instruction '" + instr.toString() + "' has no successors in function '$@cpp_'." and
    irFunc = getInstructionIRFunction(instr, irFuncText)
  }
    ...
    exists(EdgeKind kind, int n |
      ...
      message =
        "Instruction '" + source.toString() + "' has " + n.toString() + " successors of kind '" +
          kind.toString() + "' in function '$@cpp_'." and
  ...
  query predicate unexplainedLoop(
    ...
    exists(Language::Function f |
      ...
      message =
        "Instruction '" + instr.toString() + "' is part of an unexplained loop in function '$@cpp_'." and
      irFunc = getInstructionIRFunction(instr, irFuncText)
    )
  }
    ...
    exists(int n |
      ...
      message =
        "Instruction '" + instr.toString() + "' is in a block with only " + n.toString() +
          " predecessors in function '$@cpp_'." and
      irFunc = getInstructionIRFunction(instr, irFuncText)
    )
  }
    ...
    exists(MemoryOperand operand, Instruction def |
      ...
      message =
        "Memory operand definition on instruction '" + instr.toString() +
          "' has unmodeled result in function '$@cpp_'." and
      irFunc = getInstructionIRFunction(instr, irFuncText)
    )
  }
    ...
    exists(Instruction useInstr, Instruction defInstr |
      ...
      message =
        "Operand '" + operand.toString() + "' is used on instruction '" + useInstr.toString() +
          "' in function '$@cpp_', but is defined on instruction '" + defInstr.toString() +
          "' in function '$@cpp_'."
    )
  }
    ...
    exists(IRFunction f, IRBlock entry |
      ...
      message =
        "Block '" + block.toString() +
          "' is not reachable by traversing only forward edges in function '$@cpp_'." and
    ...
    exists(IRBlock useBlock, int useIndex, Instruction defInstr, IRBlock defBlock, int defIndex |
      ...
      message =
        "Operand '" + useOperand.toString() +
          "' is not dominated by its definition in function '$@cpp_'." and
  ...
  query predicate switchInstructionWithoutDefaultEdge(
    ...
    message =
      "SwitchInstruction " + switchInstr.toString() + " without a DefaultEdge in function '$@cpp_'." and
  ...
  query predicate notMarkedAsConflated(
    ...
    message =
      "Instruction '" + instr.toString() +
        "' should be marked as having a conflated result in function '$@cpp_'." and
    irFunc = getInstructionIRFunction(instr, irFuncText)
  }
  ...
  query predicate wronglyMarkedAsConflated(
    ...
    message =
      "Instruction '" + instr.toString() +
        "' should not be marked as having a conflated result in function '$@cpp_'." and
    irFunc = getInstructionIRFunction(instr, irFuncText)
  }
    ...
    exists(int irFuncCount |
      ...
      message =
        "Instruction '" + instr.toString() + "' has " + irFuncCount.toString() +
          " results for `getEnclosingIRFunction()` in function '$@cpp_'." and
      irFunc = getInstructionIRFunction(instr, irFuncText)
    )
  }
  ...
  query predicate fieldAddressOnNonPointer(
    ...
    message =
      "FieldAddress instruction '" + instr.toString() +
        "' has an object address operand that is not an address, in function '$@cpp_'." and
    irFunc = getInstructionIRFunction(instr, irFuncText)
  }
  ...
  query predicate thisArgumentIsNonPointer(
    ...
    message =
      "Call instruction '" + instr.toString() +
        "' has a `this` argument operand that is not an address, in function '$@cpp_'." and
    irFunc = getInstructionIRFunction(instr, irFuncText)
  }
}
