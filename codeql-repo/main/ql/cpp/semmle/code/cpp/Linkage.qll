 ...
 */
class LinkTarget extends @cpp_link_target {
  /**
   * Gets the file which was built.
   */
  File getBinary() { cpp_link_targets(this, unresolveElement(result)) }
   ...
   * to this link target.
   */
  Function getAFunction() { cpp_link_parent(unresolveElement(result), this) }

  /**
   * Gets a class which had its declaration included by one of the
   * translation units which contributed to this link target.
   */
  Class getAClass() { cpp_link_parent(unresolveElement(result), this) }
}
