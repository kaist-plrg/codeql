...
class Field extends MemberVariable {
  Field() { cpp_fieldoffsets(underlyingElement(this), _, _) }
   ...
   */
  int getByteOffset() { cpp_fieldoffsets(underlyingElement(this), result, _) }
...
class BitField extends Field {
  BitField() { cpp_bitfield(underlyingElement(this), _, _) }
   ...
   * were extracted).
   */
  int getNumBits() { cpp_bitfield(underlyingElement(this), result, _) }
   ...
   * 1234.
   */
  int getDeclaredNumBits() { cpp_bitfield(underlyingElement(this), _, result) }
   ...
   */
  int getBitOffset() { cpp_fieldoffsets(underlyingElement(this), _, result) }
