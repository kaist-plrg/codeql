 ...
 */
class Location extends @cpp_location {
  ...
  predicate fullLocationInfo(
    ...
    cpp_locations_default(this, unresolveElement(container), startline, startcolumn, endline, endcolumn) or
    cpp_locations_expr(this, unresolveElement(container), startline, startcolumn, endline, endcolumn) or
    cpp_locations_stmt(this, unresolveElement(container), startline, startcolumn, endline, endcolumn)
  }
 ...
 */
deprecated library class LocationDefault extends Location, @cpp_location_default { }

/**
 * DEPRECATED: Use `Location` instead.
 * A location of a statement.
 */
deprecated library class LocationStmt extends Location, @cpp_location_stmt { }

/**
 * DEPRECATED: Use `Location` instead.
 * A location of an expression.
 */
deprecated library class LocationExpr extends Location, @cpp_location_expr { }
...
class UnknownDefaultLocation extends UnknownLocation {
  UnknownDefaultLocation() { cpp_locations_default(this, _, 0, 0, 0, 0) }
}
...
class UnknownExprLocation extends UnknownLocation {
  UnknownExprLocation() { cpp_locations_expr(this, _, 0, 0, 0, 0) }
}
...
class UnknownStmtLocation extends UnknownLocation {
  UnknownStmtLocation() { cpp_locations_stmt(this, _, 0, 0, 0, 0) }
}
